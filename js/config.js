const ASSETS = {
    ...
    mascotSmall: 'assets/mascot_dino_small.png',
    iconUpload: 'assets/icon_camera.svg',
    iconStar: 'assets/icon_star.svg',
    placeholderBeast: 'assets/placeholder_beast.png',
...
const INTRO_EXAMPLES = [
    ...
    { word: 'Dog', transcription: '[dɔɡ]', translation: 'собака', image: 'assets/intro_dog.png', description: 'Собака-повар в колпаке готовит суп. "Дог" — повар размешивает суп половником.' },
